...
import tga.backup.files.SyncActionCases
...
fun runBackupScript(params: Params, srcFileOps: FileOps, dstFileOps: FileOps, srcFiles: Set<FileInfo>, dstFiles: Set<FileInfo>) {
